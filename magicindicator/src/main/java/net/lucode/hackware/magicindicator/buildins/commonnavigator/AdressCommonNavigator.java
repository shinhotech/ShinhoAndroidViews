...
/**
 * 地址特殊处理，固定末尾红色
 * Created by hackware on 2018/2/8.
 */
public class AdressCommonNavigator extends FrameLayout implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    public AdressCommonNavigator(Context context) {
        super(context);
